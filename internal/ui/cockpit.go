...
func (co *cockpit) statusLine(w int) string {
	...
	return hintLine(left, "", []string{"⏎ attach", "q quit", "m mount", "b backend",
		"tab switch", "u unmount", "/ filter"}, []string{"m mount", "u unmount",
		"b backend", "⏎ attach", "tab switch", "/ filter", "q quit"}, w)
}
